---
name: durable-mailbox-maintainer
description: Maintain deprecated durable-mailbox's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---

# Maintain durable-mailbox
...
Preserve bounded drains, retained bodies, explicit acknowledgment, and failure on contention. Delivery is not processing; interruptions can duplicate output. Keep the deprecation for new Claude session-messaging integrations visible.
